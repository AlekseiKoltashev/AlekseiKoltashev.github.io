...
<?php include_once("../includes/meta.inc.php") ?>
  <title>Абитуриенту ЮУТУ - Разработка программных решений для бизнеса</title>
</head>
        ...
        <div class="row p-1 mt-3">
          <div class="wrapper-inner background-color-white row mx-auto align-items-center py-4 px-lg-5">
            ...
            <div class="col-12 col-lg-6 text-center">
              ...
              <?php $SPEC_NAME="09.03.02 ИТ, бакалавриат, разработка программных решений для бизнеса"; ?>
                <?php
            ...
            <div class="row mb-2 mt-4">
              <div class="col-12">
                ...
                <div class="mx-1 mt-2 d-flex align-items-center">
                  <img src="./img/check-resume.png" class="align-middle" width="25px" alt="" />
                  <p class="d-inline-block my-0 ms-2 fs-6-5-suut">
                    Использование инструментов разработки, таких как среды разработки (IDE) и системы контроля версий (например, Git)
                  </p>
                </div>
                ...
                <div class="mx-1 mt-2 d-flex align-items-center">
                  <img src="./img/check-resume.png" class="align-middle" width="25px" alt="" />
                  <p class="d-inline-block my-0 ms-2 fs-6-5-suut">
                    Методики управления проектами, включая работу с современными инструментами управления, такими как Jira и Trello
                  </p>
                </div>
                ...
                <div class="mx-1 mt-2 d-flex align-items-center">
                  <img src="./img/check-resume.png" class="align-middle" width="25px" alt="" />
                  <p class="d-inline-block my-0 ms-2 fs-6-5-suut">
                    Навыки эффективного общения и взаимодействия с членами команды и заинтересованными сторонами через различные коммуникационные инструменты, такие как электронная почта, видеоконференции и чаты
                  </p>
                </div>
                ...
                <div class="mx-1 mt-2 d-flex align-items-center">
                  <img src="./img/check-resume.png" class="align-middle" width="25px" alt="" />
                  <p class="d-inline-block my-0 ms-2 fs-6-5-suut">
                    Методы обеспечения качества программного обеспечения и проведения тестирования
                  </p>
                </div>
                <div class="mx-1 mt-2 d-flex align-items-center">
                  <img src="./img/check-resume.png" class="align-middle" width="25px" alt="" />
                  <p class="d-inline-block my-0 ms-2 fs-6-5-suut">
                    Практические навыки работы с аддитивными технологиями и 3D-печатью
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-12 col-lg-6 mt-2">
            <div class="mx-1 wrapper background-color-gray px-3 px-lg-4 px-xl-5 py-3 py-xl-4 h-100">
              ...
              <div class="mx-1 mt-2 d-flex align-items-center">
                <img src="./img/check-resume.png" class="align-middle" width="25px" alt="" />
                <p class="d-inline-block my-0 ms-2 fs-6-5-suut">
                  В крупных IT-корпорациях, специализирующихся на разработке программного обеспечения для бизнеса 
                </p>
              </div>
              <div class="mx-1 mt-2 d-flex align-items-center">
                <img src="./img/check-resume.png" class="align-middle" width="25px" alt="" />
                <p class="d-inline-block my-0 ms-2 fs-6-5-suut">
                  В IT-отделах различных компаниях, где требуются специалисты по разработке программного обеспечения для автоматизации бизнес-процессов, создания корпоративных приложений и обеспечения безопасности информационных систем
                </p>
              </div>
              <div class="mx-1 mt-2 d-flex align-items-center">
                <img src="./img/check-resume.png" class="align-middle" width="25px" alt="" />
