                    ...
                    <div class="wrapper-inner background-color-white row mx-auto align-items-center py-4 px-lg-5">
                        ...
                        <div class="col-12 col-lg-6 text-center">
                            ...
                            <form action="https://api-abtr.science174.ru/feedback" method="post" id="topFormFeedback"
                                ...
                                <p class="fs-8-suut text-dark-suut"> Отправляя заявку с помощью данной формы, вы
                                    соглашаетесь с обработкой своих персональных данных в соответствии с
                                    <a href="https://www.inueco.ru/files/sveden/files/document/zachitaPD.pdf">
                                        положением</a>
                                </p>
                            </form>
                        </div>
