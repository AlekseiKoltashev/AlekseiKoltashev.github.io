        ...
        <div class="container mt-5">
            <div class="mx-1 wrapper background-color-gray px-3 px-lg-4 px-xl-5 py-4 py-xl-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-4 px-3 px-lg-5">
                        <div class="card card-suut h-100" style="width: 100%">
                            <img src="./img/draw.webp" class="card-img-top" alt="..." />
                            <div class="card-body">
                                <h5 class="card-title" >Мастерская рисунка</h5>
                                <p class="card-text text-dark-suut">
                                  Всё, что нужно для создания произведения искусства
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-4 px-3 px-lg-5">
                        <div class="card card-suut h-100" style="width: 100%">
                            <img src="./img/construirovanie.webp" class="card-img-top" alt="..." />
                            <div class="card-body">
                                <h5 class="card-title">Мастерская конструирования</h5>
                                <p class="card-text text-dark-suut">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-4 px-3 px-lg-5">
                        <div class="card card-suut h-100" style="width: 100%">
                            <img src="./img/comp_grafica.webp" class="card-img-top" alt="..." />
                            <div class="card-body">
                                <h5 class="card-title">Мастерская компьютерной графики</h5>
